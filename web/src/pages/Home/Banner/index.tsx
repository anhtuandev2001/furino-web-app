      ...
      <Slider {...settings}>
        {data.map((item) => (
          ...
          >
            ...
            />
            <div className='flex right-10 left-10 bot flex-col absolute z-10 max-w-[643px] bg-white top-1/2 -translate-y-1/2 sm:-translate-x-1/2 p-[20px] sm:left-1/2 sm:pt-[60px] sm:pb-[40px] sm:px-[40px] rounded-sm'>
